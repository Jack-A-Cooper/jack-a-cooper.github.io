    ...
    <div id="contact" className="section">
      <div className="container">
        ...
        <ul>
          ...
          <li>LinkedIn: <a href="https://www.linkedin.com/in/jackcoop" rel="noreferrer" target="_blank">Your LinkedIn</a></li>
          <li>GitHub: <a href="https://github.com/Jack-A-Cooper" rel="noreferrer" target="_blank">Your GitHub</a></li>
        </ul>
        <div className="svg-divider">
          <svg className="divider-style-main" height="20" width="100%">
            <line x1="0" y1="10" x2="100%" y2="10" />
