        ...
        <div className="container">
            ...
            <div class="svg-divider">
              ...
              <div class="container">
                      <ul class="bold">Programming Projects
                          <li class="bold"><a href="https://github.com/Jack-A-Cooper/WonderLoom" target="_blank">Wonderloom</a> | Python</li>
                          ...
                          <li class="bold"><a href="https://github.com/Jack-A-Cooper/coa-generator" target="_blank">Coat of Arms Generator (COA Gen)</a> | Python</li>
          ...
          <div className="container">
            <div class="svg-divider">
             ...
             <div class="container">
                  <ul class="bold">Programming Projects
                      <li class="bold"><a href="https://github.com/Jack-A-Cooper/PokerCore" target="_blank">Pokercore</a> | C++ (Open Source)</li>
                     ...
                     <li class="bold"><a href="https://github.com/Jack-A-Cooper/Agar.io-Behavior-Tree-Bots" target="_blank">Agar.io-Behavior-Tree-Bots Fork</a> | JavaScript (Open Source)</li>
